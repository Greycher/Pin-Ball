There is a Builds folder under the root folder that keeps two seperated builds namely first trial and second trial.
...
that working with joints needs tweaking and time. But in general I dont think this task is a task that can be fit in two hours. You are making level from boxes and it takes time also.

In my second attempt I have omitted the two hour frame from my mind and aim to make a playable game loop. The result is not perfect but as I wrote earlier working with physic takes time and tweaking and also I did not get to work on 
